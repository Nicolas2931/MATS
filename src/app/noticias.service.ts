...
export class NoticiasService {
  ...
  noticia1:Noticia =
  new Noticia("Investigadores de la Universidad XYZ descubren posible cura para el cáncer"
  ,"15 de abril de 2023",
  ...
  noticia2:Noticia=new Noticia("Estudiante de la Universidad ABC gana prestigioso premio de matemáticas",
  "2 de mayo de 2023",
  ...
  noticia3:Noticia=new Noticia("Nueva conferencia sobre inteligencia artificial en la Universidad XYZ",
  "10 de junio de 2023",
  ...
  noticia4:Noticia=new Noticia("Investigadores de la Universidad ABC descubren nueva especie de mariposa",
  "18 de julio de 2023",
  ...
  noticia5:Noticia=new Noticia("Concurso de diseño sostenible en la Facultad de Arquitectura",
  ...
  noticia6:Noticia=new Noticia("Investigadores de la Universidad ABC publican estudio sobre cambio climático",
  ...
  noticia7:Noticia=new Noticia("Jornada de voluntariado en la Universidad XYZ",
  "15 mayo de 2023",
  ...
  noticia8:Noticia=new Noticia("Nueva exposición de arte en el campus de la Universidad ABC",
  ...
  noticia9:Noticia=new Noticia("Conferencia sobre medicina personalizada en la Universidad XYZ",
  "18 de enero de 2024",
  ...
  noticia10:Noticia=new Noticia("Estudiantes de la Universidad ABC obtienen becas para estudiar en el extranjero",
